...
namespace XLib.Unity.Scene.SortingLayer {
	...
	public class SortingLayerExposedEditor : Editor {
		...
		public override void OnInspectorGUI() {
			...
			var oldName = UnityEngine.SortingLayer.IDToName(renderer.sortingLayerID);
			...
			var newSortingLayerOrder = EditorGUILayout.IntField("Sorting Layer Order", renderer.sortingOrder);
