...
public partial class LevelEntity {
    ...
    public Client.Entitas.Components.PositionComponent position { get { return (Client.Entitas.Components.PositionComponent)GetComponent(LevelComponentsLookup.Position); } }
    ...
    public void AddPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Client.Entitas.Components.PositionComponent)CreateComponent(index, typeof(Client.Entitas.Components.PositionComponent));
