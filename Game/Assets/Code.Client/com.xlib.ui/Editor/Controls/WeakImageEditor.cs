...
namespace XLib.UI.Controls {
	...
	[CustomEditor(typeof(WeakImage), true)]
	[CanEditMultipleObjects]
	public class WeakImageEditor : GraphicEditor {
        ...
        protected void TypeGUI()
        {
            ...
            ++EditorGUI.indentLevel;
            {
                ...
                var showSlicedOrTiled = (!m_Type.hasMultipleDifferentValues && (typeEnum == Image.Type.Sliced || typeEnum == Image.Type.Tiled));
                ...
                {
                    if (image.Reference != null && !image.hasBorder)
                ...
                {
                    if (image.Reference != null && !image.hasBorder && (image.Reference.texture != null && image.Reference.texture.wrapMode != TextureWrapMode.Repeat || image.Reference.packed))
