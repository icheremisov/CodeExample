...
namespace XLib.Unity.Scene.SortingLayer {
	...
	public class SortingLayerDrawer : PropertyDrawer {
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
			...
			if (property.propertyType != SerializedPropertyType.Integer)
				...
				var oldName = UnityEngine.SortingLayer.IDToName(property.intValue);
				...
				if (newLayerIndex != oldLayerIndex) property.intValue = UnityEngine.SortingLayer.NameToID(sortingLayerNames[newLayerIndex]);
