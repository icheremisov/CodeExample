...
public static partial class GameObjectExtensions {
	...
	/// <summary>
	///     Returns a collection of GameObjects that contains every GameObject in the source collection, and the ancestors
	///     of every GameObject in the source collection.
	/// </summary>
	...
	/// <summary>
	///     Returns a collection of GameObjects that contains the descendant GameObjects of every GameObject in the source
	///     collection.
	/// </summary>
	...
	/// <summary>
	///     Returns a collection of GameObjects that contains every GameObject in the source collection, and the
	///     descendent GameObjects of every GameObject in the source collection.
	/// </summary>
	...
	/// <summary>
	///     Returns a collection of GameObjects that contains every GameObject in the source collection, and the child
	///     GameObjects of every GameObject in the source collection.
	/// </summary>
	...
	public static void Destroy(this IEnumerable<GameObject> source, bool useDestroyImmediate = false, bool detachParent = false) {
		if (detachParent) {
			...
			while (e.MoveNext()) e.Current.Destroy(useDestroyImmediate, true);
		}
		else
			foreach (var item in source)
				item.Destroy(useDestroyImmediate); // doesn't detach.
	}
	...
	private class ComponentCache<T> {
		...
		public static readonly List<T> Instance = new(); // for no allocate on UNITY_EDITOR
