		...
		public class PoolKitMenuItems : MonoBehaviour {
			...
			*/
			...
			static void SetupGlobalPools()
			{
				...
				if( !Directory.Exists( prefix + "ThirdParty/PoolKit/Global/Resources/" )){
					Directory.CreateDirectory( prefix + "ThirdParty/PoolKit/Global/Resources/" );
					_assetDatabaseNeedsRefreshing = true;
				}

				// Create Plugins / Hell Tap Entertainment Folder / PoolKit / Global / PoolKit Global Pools
				if( !File.Exists( prefix + "ThirdParty/PoolKit/Global/Resources/PoolKit Global Pools.asset" ) ){
					...
					AssetDatabase.CreateAsset( globalPoolsAsset, "Assets/ThirdParty/PoolKit/Global/Resources/PoolKit Global Pools.asset" );
				...
				// This means the asset already exists, select it
					...
					Selection.activeObject = AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/PoolKit/Global/Resources/PoolKit Global Pools.asset", typeof(GlobalPools) );
				}
